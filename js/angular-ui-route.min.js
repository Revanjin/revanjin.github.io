...
!function(t, e) {
    ...
    function c(t) {
        if (ee(t) && t.length) {
            ...
            return !(e.filter(qt(Xt)).length || r.filter(qt(Yt)).length)
        }
        return Yt(t)
    }
    ...
    function w(t, e) {
        return Object.keys(t).filter(qt(ve(e))).reduce(function(e, r) {
            return e[r] = t[r], e
        }, {})
    }
    ...
    function E(t, e) {
        return void 0 === e && (e = "assert failure"), function(r) {
            var n = t(r);
            if (!n) throw new Error(Yt(e) ? e(r) : e);
            return n
        }
    }
    ...
    function T(t, e) {
        var r, n;
        if (ee(e) && (r = e[0], n = e[1]), !Xt(r)) throw new Error("invalid parameters to applyPairs");
        return t[r] = n, t
    }
    ...
    function x(t, e) {
        ...
        var n = [t, e];
        if (Dt(ee)(n)) return I(t, e);
        if (Dt(re)(n)) return t.getTime() === e.getTime();
        if (Dt(ne)(n)) return t.toString() === e.toString();
        if (Dt(Yt)(n)) return !0;
        if ([Yt, ee, re, ne].map(Ft).reduce(function(t, e) {
                return t || !!e(n)
            }, !1)) return !1;
        var i, o = {};
        for (i in t) {
    ...
    function H(t, e, r) {
        function n(t, n, o) {
            void 0 === o && (o = {});
            var a = new ze(e, r, n, t, o);
            return i.push(a), function() {
                a._deregistered = !0, me(i)(a)
            }
        }

        var i = (t._registeredHooks = t._registeredHooks || {})[r.name] = [];
        return t[r.name] = n, n
    }
    ...
    function U(t, e, r) {
        var n = t.squash;
        if (!e || !1 === n) return !1;
        if (!Jt(n) || null == n) return r;
        if (!0 === n || Xt(n)) return n;
    ...
    function L(t, e, r, n) {
        ...
        return i = ee(t.replace) ? t.replace : [], Xt(n) && i.push({
            from: n,
            to: void 0
        }), o = b(i, Vt("from")), $(a, function(t) {
    ...
    function K(t, e) {
        return Xt(P(t)) && Xt(e) ? t.slice(0, -1).concat(P(t) + e) : R(t, e)
    }
    ...
    function rt(t) {
        var e = function(t) {
            ...
            return !!(t && t.val && (Xt(t.val) || ee(t.val) || Yt(t.val)))
        }, o], [Lt(!0), function(t) {
            throw new Error("Invalid resolve value: " + J(t))
        }]]), u = t.resolve;
        return (ee(u) ? u : function(t, e) {
    ...
    function ot(t) {
        if (!(Yt(t) || Xt(t) || Nt(Be)(t) || Be.isDef(t))) throw new Error("'handler' must be a string, function, TargetState, or have a state: 'newtarget' property");
        return Yt(t) ? t : Lt(t)
    }
    ...
    function st(t, e) {
        ...
        if (!n) {
            n = r._promise = ue.$q.when(r(t, e)).then(function(e) {
                ...
                return delete r._promise, ue.$q.reject(t)
            })
        }
        return n
    }
    ...
    function pt() {
        ...
        try {
            return new CustomEvent("foo"), CustomEvent
        } catch (e) {
            return t
        }
    }
    ...
    function vt() {
        var t = null;
        return function(e, r) {
            return t = t || ue.$injector.get("$templateFactory"), [new ei(e, r, t)]
        }
    }
    ...
    function mt(t) {
        ...
        if (Jt(t.views) && Xn(i, t)) throw new Error("State '" + t.name + "' has a 'views' object. It cannot also have \"view properties\" at the state level.  Move the following properties into a view (in the 'views' object):  " + i.filter(function(e) {
            return Jt(t[e])
        }).join(", "));
        var o = {}, a = t.views || {$default: g(t, i)};
        return le(a, function(e, i) {
            if (i = i || "$default", Xt(e) && (e = {component: e}), e = he({}, e), Xn(r, e) && Xn(n, e)) throw new Error("Cannot combine: " + r.join("|") + " with: " + n.join("|") + " in stateview: '" + i + "@" + t.name + "'");
    ...
    function yt(t) {
        var e = ue.$injector.get(t + "Directive");
    ...
    function gt(t) {
        ...
        (di = this.router = new Xr).stateProvider = new oi(di.stateRegistry, di.stateService), di.stateRegistry.decorator("views", mt), di.stateRegistry.decorator("onExit", ai("onExit")), di.stateRegistry.decorator("onRetain", ai("onRetain")), di.stateRegistry.decorator("onEnter", ai("onEnter")), di.viewService._pluginapi._viewConfigFactory("ng1", vt());
    ...
    function wt(t, e, r) {
        ue.$injector = t, ue.$q = e, r.stateRegistry.get().map(function(t) {
    ...
    function St(t) {
        var e = t.parent().inheritedData("$uiView"), r = Ht("$cfg.path")(e);
        return r ? P(r).state.name : void 0
    }

    function bt(t, e, r) {
        var n = r.uiState || t.current.name, i = he(Ct(e, t), r.uiStateOpts || {}), o = t.href(n, r.uiStateParams, i);
    ...
    function Ot(t, r, n, i, o, a) {
        var u = Ht("viewDecl.controllerAs"), s = Ht("viewDecl.resolveAs");
        return {
            restrict: "ECA", priority: -400, compile: function(i) {
                ...
                return i.empty(), function(i, c) {
                    ...
                    if (Xt(l.viewDecl.component)) var w = l.viewDecl.component, _ = G(w),
                        $ = new RegExp("^(x-|data-)?" + _ + "$", "i"), S = i.$watch(function() {
                            var t = [].slice.call(c[0].children).filter(function(t) {
                                return t && t.tagName && $.exec(t.tagName)
                            });
                            return t && jt.element(t).data("$" + w + "Controller")
                        }, function(t) {
                            t && (xt(o, n, t, i, l), S())
                        });
                    p(i)
    ...
    function xt(t, e, r, n, i) {
        !Yt(r.$onInit) || i.viewDecl.component && $i || r.$onInit();
        var o = P(i.path).state.self, a = {bind: r};
        if (Yt(r.uiOnParamsChanged)) {
    ...
    var It = angular, jt = e && e.module ? e : It, Vt = function(t) {
            return function(e) {
                return e && e[t]
            }
        }, At = r(function(t, e, r) {
            ...
            return t.create = function(e) {
                ...
                return e.$$state = function() {
                    return r
                }, r.self = e, r.__stateObjectCache = {nameGlob: Mt.fromString(r.name)}, r
                ...
                return void 0 === e && (e = {}), this.url && this.url.parameter(t, e) || S($e(this.params), At("id", t)) || e.inherit && this.parent && this.parent.parameter(t)
            }, t.prototype.toString = function() {
                return this.fqn()
            }, t.isStateClass = function(t) {
                return Yt(t) && !0 === t.__uiRouterState
            }, t.isState = function(t) {
                return te(t.__stateObjectCache)
            }, t
        }(), Gt = Object.prototype.toString, Wt = function(t) {
            return function(e) {
                return typeof e === t
            }
        }, zt = Wt("undefined"), Jt = qt(zt), Qt = function(t) {
            return null === t
        }, Kt = a(Qt, zt), Yt = Wt("function"), Zt = Wt("number"), Xt = Wt("string"), te = function(t) {
            return null !== t && "object" == typeof t
        }, ee = Array.isArray, re = function(t) {
            return "[object Date]" === Gt.call(t)
        }, ne = function(t) {
            return "[object RegExp]" === Gt.call(t)
        }, ie = Bt.isState, oe = o(te, i(Vt("then"), Yt)), ae = function(t) {
            return function() {
                throw new Error(t + "(): No coreservices implementation for UI-Router is loaded.")
            }
        }, ue = {$q: void 0, $injector: void 0}, se = ("undefined" == typeof window ? {} : window).angular || {},
        ce = se.fromJson || JSON.parse.bind(JSON), fe = se.toJson || JSON.stringify.bind(JSON),
        le = se.forEach || function(t, e, r) {
            if (ee(t)) return t.forEach(e, r);
            ...
            return ee(e) ? t.concat(e.reduce(Ee, [])) : R(t, e)
        }, Ce = function(t, e) {
    ...
    var Fe = Ht("$id"), Ne = Ht("router.$id"), Ue = function(t) {
        ...
        return e.prototype._set = function(e, r) {
            ...
            if (this.enabled(t.Category.HOOK)) {
                var i = Ht("traceData.hookType")(n) || "internal",
                    o = Ht("traceData.context.state.name")(n) || Ht("traceData.context")(n) || "unknown",
    ...
    var Be = function() {
        ...
        return t.prototype.name = function() {
            ...
            return t && t.state && (Xt(t.state) || Xt(t.state.name))
        }, t
        ...
        return e.prototype.logError = function(t) {
            ...
            if (!e._deregistered) {
                ...
                try {
                    ...
                    return !this.type.synchronous && oe(a) ? a.catch(function(t) {
            ...
            return r || (oe(t) ? t.then(function(t) {
                return e.handleHookResult(t)
            }) : (Me.traceHookResult(t, this.transition, this.options), !1 === t ? He.aborted("Hook aborted transition").toPromise() : Nt(Be)(t) ? He.redirected(t).toPromise() : void 0))
            ...
            return (Ht("traceData.hookType")(e) || "internal") + " context: " + (Ht("traceData.context.state.name")(e) || Ht("traceData.context")(e) || "unknown") + ", " + M(200, z(r.callback))
        ...
        return e.prototype.buildHooksForPhase = function(t) {
            ...
            }).filter(ke(ee, "broken event named: " + e.name)).reduce(Re, []).filter(function(t) {
                return t.matches(r)
            })
        }, e
    }(), Qe = function() {
    ...
    var Ze = function() {
            function e(e, r, n, i, o) {
                ...
                var u = void 0 !== n.value || i === t.DefType.SEARCH, s = Jt(n.dynamic) ? !!n.dynamic : !!r.dynamic,
                    c = Jt(n.raw) ? !!n.raw : !!r.raw, f = U(n, u, o.defaultSquashPolicy()), l = L(n, a, u, f),
                    h = Jt(n.inherit) ? !!n.inherit : !!r.inherit;
                he(this, {
                    id: e,
                    type: r,
                    location: i,
            ...
            return e.prototype.isDefaultValue = function(t) {
                ...
                return t = function(t) {
                    ...
                    if (!ue.$injector) throw new Error("Injectable functions cannot be called at configuration time");
                    var t = ue.$injector.invoke(e.config.$$fn);
            ...
            return t.prototype.applyRawParams = function(t) {
                ...
                return S(this.paramSchema, At("id", t))
            }, t.prototype.equals = function(t, e) {
                var r = this.diff(t, e);
                return r && 0 === r.length
            ...
            return t.makeTargetState = function(t, e) {
                var r = P(e).state;
                return new Be(t, r, e.map(Vt("paramValues")).reduce(we, {}), {})
                ...
                return e.map(function(e) {
                    ...
                    o = w(o, r);
                    var u = w(n(t, e.state) || {}, i), s = he(o, u, a);
            ...
            function t(e, r, n, i, o) {
                if (this.resolved = !1, this.promise = void 0, e instanceof t) he(this, e); else if (Yt(r)) {
                    if (Kt(e)) throw new Error("new Resolvable(): token argument is required");
                    if (!Yt(r)) throw new Error("new Resolvable(): resolveFn argument must be a function");
                    this.token = e, this.policy = i, this.resolveFn = r, this.deps = n || [], this.data = o, this.resolved = void 0 !== o, this.promise = this.resolved ? ue.$q.when(this.data) : void 0
                } else if (te(e) && e.token && Yt(e.resolveFn)) {
                    var a = e;
            ...
            return t.prototype.getPolicy = function(t) {
                ...
                var r = this, n = ue.$q, i = t.findNode(this), o = i && i.state,
        ...
        }(), nr = {when: {LAZY: "LAZY", EAGER: "EAGER"}, async: {WAIT: "WAIT", NOWAIT: "NOWAIT", RXWAIT: "RXWAIT"}},
        ir = nr.when, or = [ir.EAGER, ir.LAZY], ar = [ir.EAGER], ur = "Native Injector", sr = function() {
            function t(t) {
                this._path = t
            }
            ...
            return t.prototype.getTokens = function() {
                ...
                var r = S(this._path, At("state", e)), n = t.map(function(t) {
                    return t.token
                });
                ...
                var i = function(t, e) {
                    ...
                    var a = o.resolvables.filter(i(n, "when")), u = a.filter(i(["NOWAIT"], "async")),
                        s = a.filter(qt(i(["NOWAIT"], "async"))), c = r.subContext(o.state), f = function(t) {
                ...
                return t.deps.map(function(t) {
                    ...
                    if (zt(i)) throw new Error("Could not find Dependency Injection token: " + J(t));
            ...
            function t(t) {
                this.context = t, this.native = this.get(ur) || ue.$injector
            }
            ...
            return t.prototype.get = function(t) {
                ...
                var e = this.context.getResolvable(t);
                return e ? e.get(this.context) : ue.$q.when(this.native.get(t))
            }, t.prototype.getNative = function(t) {
                return this.native && this.native.get(t)
            }, t
        }(), fr = Vt("self"), lr = function() {
            function e(e, r, n) {
                var i = this;
                if (this._deferred = ue.$q.defer(), this.promise = this._deferred.promise, this._registeredHooks = {}, this._hookBuilder = new Je(this), this.isActive = function() {
                        return i.router.globals.transition === i
                    }, this.router = n, this._targetState = r, !r.valid()) throw new Error(r.error());
                this._options = he({current: Lt(this)}, r.options()), this.$id = n.transitionService._transitionCount++;
            ...
            return e.prototype.onBefore = function(t, e, r) {
                ...
                return void 0 === t && (t = "to"), Object.freeze(this._treeChanges[t].map(Vt("paramValues")).reduce(we, {}))
                ...
                void 0 === e && (e = ""), t = Nt(rr)(t) ? t : new rr(t);
                ...
                return b(this._treeChanges.entering, Vt("state")).map(fr)
            }, e.prototype.exiting = function() {
                return b(this._treeChanges.exiting, Vt("state")).map(fr).reverse()
            }, e.prototype.retained = function() {
                return b(this._treeChanges.retained, Vt("state")).map(fr)
            }, e.prototype.views = function(t, e) {
                void 0 === t && (t = "entering");
                var r = this._treeChanges[t];
                return (r = e ? r.filter(At("state", e)) : r).map(Vt("views")).filter(f).reduce(Re, [])
                ...
                return tr.matching(u, a, tr.nonDynamicParams).filter(qt(function(t) {
                    return function(e) {
                ...
                if (!(this._options.reload || t.exiting.length || t.entering.length || t.to.length !== t.from.length || C(t.to, t.from).map(function(t) {
                ...
                return We.invokeHooks(i, function() {
                    ...
                    return t.lastStartedTransitionId = e.$id, t.transition = e, t.transitionHistory.enqueue(e), Me.traceTransitionStart(e), ue.$q.when(void 0)
                }).then(function() {
                    var e = n(t.TransitionHookPhase.RUN);
                    return We.invokeHooks(e, function() {
                        return ue.$q.when(void 0)
                    })
                }).then(function() {
                ...
                zt(this.success) && (this._aborted = !0)
                ...
                return "Transition#" + this.$id + "( '" + (te(t) ? t.name : t) + "'" + J(r(this._treeChanges.from.map(Vt("paramValues")).reduce(we, {}))) + " -> " + (this.valid() ? "" : "(X) ") + "'" + (te(e) ? e.name : e) + "'" + J(r(this.params())) + " )"
            }, e.diToken = e, e
        }(), hr = null, pr = function(t) {
            var e = He.isRejectionPromise;
            return (hr = hr || s([[qt(Jt), Lt("undefined")], [Qt, Lt("null")], [oe, Lt("[Promise]")], [e, function(t) {
                return t._transitionRejection.toString()
            }], [Nt(He), u("toString")], [Nt(lr), u("toString")], [Nt(rr), u("toString")], [c, W], [Lt(!0), f]]))(t)
        }, dr = function(t) {
            return function(e) {
                if (!e) return ["", ""];
                var r = e.indexOf(t);
            ...
            return t.replace(/\/[^/]*$/, "")
        }, yr = dr("#"), gr = dr("?"), wr = dr("="), _r = function(t) {
            return t ? t.replace(/^#/, "") : ""
        }, $r = function() {
            function t() {
            ...
            return t.prototype.dispose = function() {
                ...
                if (!Jt(e)) return this.types[t];
                if (this.types.hasOwnProperty(t)) throw new Error("A type named '" + t + "' has already been defined.");
                return this.types[t] = new Qe(he({name: t}, e)), r && (this.typeQueue.push({
                    name: t,
                    def: r
                ...
                for (; this.typeQueue.length;) {
                    ...
                    he(this.types[t.name], ue.$injector.invoke(t.def))
                }
            }, t
        }();
    !function() {
        var t = function(t) {
            var e = function(t) {
                ...
                encode: e, decode: e, is: Nt(String), pattern: /.*/, equals: function(t, e) {
                    return t == e
                }
            };
            return he({}, r, t)
        ...
        he($r.prototype, {
            ...
            json: t({encode: fe, decode: ce, is: Nt(Object), equals: pe, pattern: /[^/]*/}),
            any: t({
    ...
    var Sr, br = function() {
        ...
        return function(e) {
            var r = e.url && e.url.parameters({inherit: !1}) || [],
                n = $e(_e(w(e.params || {}, r.map(Vt("id"))), function(e, r) {
        ...
        return t.prototype.builder = function(t, e) {
            ...
            return Xt(t) && !Jt(e) ? n.length > 1 ? n : n[0] : Xt(t) && Yt(e) ? (r[t] = n, r[t].push(e), function() {
            ...
            return t.parent ? Xt(t.parent) ? t.parent : t.parent.name : ""
        }, t.prototype.name = function(t) {
            var e = t.name;
            if (-1 !== e.indexOf(".") || !t.parent) return e;
            var r = Xt(t.parent) ? t.parent : t.parent.name;
            return r ? r + "." + e : e
        }, t
    }(), kr = function() {
        function t(t) {
        ...
        return t.prototype.dispose = function() {
            ...
            var e = this.queue, r = Bt.create(t), n = r.name;
            if (!Xt(n)) throw new Error("State must have a valid name");
            if (this.states.hasOwnProperty(n) || ve(e.map(Vt("name")), n)) throw new Error("State '" + n + "' is already defined");
        ...
        return t.prototype._registerRoot = function() {
            ...
            return o.forEach(function(t) {
                ...
                r.rules().filter(At("state", t)).forEach(r.removeRule.bind(r)), delete e.states[t.name]
            }), o
        ...
        function e(t, r, n, i) {
            ...
            for (var a, u, s, c = /([:*])([\w\[\]]+)|\{([\w\[\]]+)(?:\:\s*((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g, l = /([:]?)([\w\[\].-]+)|\{([\w\[\].-]+)(?:\:\s*((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g, h = 0, p = [], d = function(r) {
                ...
                if (S(o._params, At("id", r))) throw new Error("Duplicate parameter name '" + r + "' in pattern '" + t + "'")
            }, v = function(e, n) {
        ...
        return e.prototype.append = function(t) {
            ...
            var o = Ir(this._cache, "pattern", function() {
                return new RegExp(["^", Te(i._cache.path.map(Vt("_compiled"))).join(""), !1 === i.config.strict ? "/?" : "", "$"].join(""), i.config.caseInsensitive ? "i" : void 0)
            }).exec(t);
            if (!o) return null;
            ...
            for (var l = 0; l < c; l++) {
                ...
                }(p)), Jt(p) && (p = h.type.decode(p)), f[h.id] = h.value(p)
            }
            return s.forEach(function(t) {
                for (var r = e[t.id], n = 0; n < t.replace.length; n++) t.replace[n].from === r && (r = t.replace[n].to);
                Jt(r) && (r = t.type.decode(r)), f[t.id] = t.value(r)
            }), r && (f["#"] = r), f
        }, e.prototype.parameters = function(t) {
            return void 0 === t && (t = {}), !1 === t.inherit ? this._params : Te(this._cache.path.map(function(t) {
                return t._params
            }))
            ...
            var a = i.reduce(function(t, r) {
                ...
                return !0 === n ? t.match(/\/$/) ? t.slice(0, -1) : t : Xt(n) ? t + n : !1 !== n ? t : null == i ? t : ee(i) ? t + b(i, e.encodeDashes).join("-") : o.raw ? t + i : t + encodeURIComponent(i)
            }, ""), u = o.map(function(t) {
                var e = t.param, r = t.squash, n = t.encoded, i = t.isDefaultValue;
                if (!(null == n || i && !1 !== r) && (ee(n) || (n = [n]), 0 !== n.length)) return e.raw || (n = b(n, encodeURIComponent)), n.map(function(t) {
                    return e.id + "=" + t
                })
            ...
            var n = function(t) {
                ...
                return t._cache.weights = t._cache.weights || n(t).map(function(t) {
                    return "/" === t ? 1 : Xt(t) ? 2 : t instanceof Ze ? 3 : void 0
                })
            }, o = i(t), a = i(r);
            !function(t, e, r) {
        ...
        return e.prototype.caseInsensitive = function(t) {
            return this._isCaseInsensitive = Jt(t) ? t : this._isCaseInsensitive
        }, e.prototype.strictMode = function(t) {
            return this._isStrictMode = Jt(t) ? t : this._isStrictMode
        }, e.prototype.defaultSquashPolicy = function(t) {
            if (Jt(t) && !0 !== t && !1 !== t && !Xt(t)) throw new Error("Invalid squash policy: " + t + ". Valid policies: false, true, arbitrary-string");
            return this._defaultSquashPolicy = Jt(t) ? t : this._defaultSquashPolicy
        ...
        return t.prototype.compile = function(t) {
            ...
            var r = e;
            Xt(e) && (e = this.router.urlMatcherFactory.compile(e)), Nt(Vr)(e) && (r = function(t) {
                return e.format(t)
            });
            var n = {
    ...
    var Lr = function() {
            function t(e) {
                this._sortFn = Sr, this._rules = [], this.interceptDeferred = !1, this._id = 0, this._sorted = !1, this._router = e, this.urlRuleFactory = new Hr(e), h(Lt(t.prototype), this, Lt(this))
            }
            ...
            return t.prototype.dispose = function() {
                ...
                var e = ot(t);
                this._otherwiseFn = this.urlRuleFactory.create(Lt(!0), e), this._sorted = !1
                ...
                return Jt(r && r.priority) && (n.priority = r.priority), this.rule(n), n
            ...
            return t.prototype._rootViewContext = function(t) {
                ...
                void 0 === e && (e = "");
                var r = e.split("@"), n = r[0] || "$default", i = Xt(r[1]) ? r[1] : "^",
                    o = /^(\^(?:\.\^)*)\.(.*$)/.exec(n);
                return o && (i = o[1], n = o[2]), "!" === n.charAt(0) && (n = n.substr(1), i = ""), /^(\^(?:\.\^)*)$/.exec(i) ? i = i.split(".").reduce(function(
                    t,
                    e
                ) {
                    return t.parent
        ...
        }, Wr = ["url", "path", "search", "hash", "onChange"],
        zr = ["port", "protocol", "host", "baseHref", "html5Mode", "hashPrefix"],
        Jr = ["type", "caseInsensitive", "strictMode", "defaultSquashPolicy"],
        Qr = ["sort", "when", "initial", "otherwise", "rules", "rule", "removeRule"],
        Kr = ["deferIntercept", "listen", "sync", "match"], Yr = function() {
            ...
            function e(e) {
                if (e) return e instanceof Be ? e : Xt(e) ? n.target(e, t.params(), t.options()) : e.state || e.params ? n.target(e.state || t.to(), e.params || t.params(), t.options()) : void 0
            }

            var r = t.to().redirectTo;
            if (r) {
                var n = t.router.stateService;
                return Yt(r) ? ue.$q.when(r(t)).then(e) : e(r)
            }
        }, rn = function(t) {
            return t.onStart({
                to: function(t) {
            ...
            return t.onEnter({entering: Lt(!0)}, hn, {priority: 1e3})
        }, dn = function(t) {
            var e = ue.$q, r = t.views("entering");
            ...
            return t.onSuccess({}, _n, {priority: 9999})
        }, Sn = function(t) {
            ...
            return ue.$q.all(r).then(function() {
            ...
            function e(t) {
                this._transitionCount = 0, this._eventTypes = [], this._registeredHooks = {}, this._criteriaPaths = {}, this._router = t, this.$view = t.viewService, this._deregisterHookFns = {}, this._pluginapi = h(Lt(this), {}, Lt(this), ["_definePathType", "_defineEvent", "_getPathTypes", "_getEvents", "getHooks"]), this._defineCorePaths(), this._defineCoreEvents(), this._registerCoreTransitionHooks()
            }
            ...
            return e.prototype.onCreate = function(t, e, r) {
                ...
                return (Jt(t) ? this._eventTypes.filter(function(e) {
                ...
                t.addCoreResolves = tn(this), t.ignored = En(this), t.invalid = Cn(this), t.redirectTo = rn(this), t.onExit = on(this), t.onRetain = un(this), t.onEnter = cn(this), t.eagerResolve = ln(this), t.lazyResolve = pn(this), t.loadViews = vn(this), t.activateViews = yn(this), t.updateGlobals = wn(this), t.updateUrl = $n(this), t.lazyLoad = bn(this)
            }, e
        }(), kn = function() {
            function e(t) {
                ...
                var r = ["current", "$current", "params", "transition"], n = Object.keys(e.prototype).filter(qt(ve(r)));
                h(Lt(e.prototype), this, Lt(this), n)
            }
            ...
            return Object.defineProperty(e.prototype, "transition", {
                ...
                function r() {
                    var t = s.dequeue();
                    return void 0 === t ? He.invalid(e.error()).toPromise() : ue.$q.when(t(e, i, c)).then(f).then(function(t) {
                        return t || r()
                    })
                }

                var n = this, i = tr.makeTargetState(this.router.stateRegistry, t), o = this.router.globals,
                    a = function() {
                ...
                return this.transitionTo(this.current, this.params, {reload: !Jt(t) || t, inherit: !1, notify: !1})
            }, e.prototype.go = function(t, e, r) {
                var n = m(r, {relative: this.$current, inherit: !0}, Tn);
                return this.transitionTo(t, e, n)
            }, e.prototype.target = function(t, e, r) {
                if (void 0 === r && (r = {}), te(r.reload) && !r.reload.name) throw new Error("Invalid reload state object");
                var n = this.router.stateRegistry;
                if (r.reloadState = !0 === r.reload ? n.root() : n.matcher.find(r.reload, r.relative), r.reload && !r.reloadState) throw new Error("No such reload state '" + (Xt(r.reload) ? r.reload : r.reload.name) + "'");
                ...
                var c = function(e) {
                    return function(r) {
                        if (r instanceof He) {
                            ...
                            if (r.type === t.RejectType.IGNORED) return n && o.urlRouter.update(), ue.$q.when(a.current);
                            var u = r.detail;
                            if (r.type === t.RejectType.SUPERSEDED && r.redirected && u instanceof Be) {
                                var s = e.redirect(u);
                                return s.run().catch(c(s))
                            }
                            if (r.type === t.RejectType.ABORTED) return n && o.urlRouter.update(), ue.$q.reject(r)
                        }
                        return i.defaultErrorHandler()(r), ue.$q.reject(r)
                    }
            ...
            get: function(t) {
                ...
                if (ee(t)) return t.slice(0, -1);
                var e = t.toString().replace(In, "");
                return e.slice(e.indexOf("(") + 1, e.indexOf(")")).match(jn) || []
            }
        }, An = function(t, e) {
            var r = e[0], n = e[1];
            return t.hasOwnProperty(r) ? ee(t[r]) ? t[r].push(n) : t[r] = [t[r], n] : t[r] = n, t
        }, Hn = function(t) {
            return t.split("&").filter(f).map(wr).reduce(An, {})
        }, qn = function(t) {
            var e = t.path(), r = t.search(), n = t.hash(), i = Object.keys(r).map(function(t) {
                var e = r[t];
                return (ee(e) ? e : [e]).map(function(e) {
                    return t + "=" + e
                })
            }).reduce(Re, []).join("&");
            return e + (i ? "?" + i : "") + (n ? "#" + n : "")
            ...
            function t(t, e) {
                ...
                }, this._location = self && self.location, this._history = self && self.history
            }

            return t.prototype.url = function(t, e) {
                if (void 0 === e && (e = !0), Jt(t) && t !== this._get() && (this._set(null, null, t, e), this.fireAfterUpdate)) {
                    var r = he(new Dn("locationchange"), {url: t});
            ...
            function e(e) {
                ...
                return self.addEventListener("hashchange", r._listener, !1), r
            }

            return Nn(e, t), e.prototype._get = function() {
                return _r(this._location.hash)
            }, e.prototype._set = function(t, e, r, n) {
                this._location.hash = r
            }, e.prototype.dispose = function(e) {
                t.prototype.dispose.call(this, e), self.removeEventListener("hashchange", this._listener)
            }, e
        }(Fn), Ln = function() {
            var t = Object.setPrototypeOf || {__proto__: []} instanceof Array && function(t, e) {
                t.__proto__ = e
            ...
            function e(e) {
                ...
                return r._config = e.urlService.config, self.addEventListener("popstate", r._listener, !1), r
            }
            ...
            return Bn(e, t), e.prototype._getBasePrefix = function() {
                ...
                t.prototype.dispose.call(this, e), self.removeEventListener("popstate", this._listener)
            }, e
        }(Fn), Wn = function() {
            return function() {
                var t = this;
                this._baseHref = "", this._port = 80, this._protocol = "http", this._host = "localhost", this._hashPrefix = "", this.port = function() {
                    ...
                    return Jt(e) ? t._hashPrefix = e : t._hashPrefix
                }, this.dispose = l
            }
        }(), zn = function() {
            function t(t, e) {
            ...
            return t.prototype.port = function() {
                ...
                return Jt(t) ? this._hashPrefix = t : this._hashPrefix
            }, t.prototype.baseHref = function(t) {
                return Jt(t) ? this._baseHref = t : Jt(this._baseHref) ? this._baseHref : this.applyDocumentBaseHref()
        ...
        Kn = ht("vanilla.memoryLocation", !1, Mn, Wn), Yn = function() {
            ...
            function t(t, e, r) {
                var n = this;
                this.path = t, this.viewDecl = e, this.factory = r, this.$id = ti++, this.loaded = !1, this.getTemplate = function(
                    t,
                    e
                ) {
            ...
            return t.prototype.load = function() {
                var t = this, e = ue.$q, r = new sr(this.path), n = this.path.reduce(function(t, e) {
                    return he(t, e.paramValues)
                }, {}), i = {
                ...
                var r = ue.$injector.annotate(e), n = ee(e) ? P(e) : e;
                return new rr("", n, r).get(t)
            }, t
        }(), ri = function() {
            function t() {
                var t = this;
                this._useHttp = jt.version.minor < 3, this.$get = ["$http", "$templateCache", "$injector", function(
                    e,
                    r,
                    n
                ) {
            ...
            return t.prototype.useHttpService = function(t) {
                ...
                var n = function(t) {
                    return ue.$q.when(t).then(function(t) {
                        return {template: t}
                    })
                }, i = function(t) {
                    return ue.$q.when(t).then(function(t) {
                ...
                return Jt(t.template) ? n(this.fromString(t.template, e)) : Jt(t.templateUrl) ? n(this.fromUrl(t.templateUrl, e)) : Jt(t.templateProvider) ? n(this.fromProvider(t.templateProvider, e, r)) : Jt(t.component) ? i(t.component) : Jt(t.componentProvider) ? i(this.fromComponentProvider(t.componentProvider, e, r)) : n("<ui-view></ui-view>")
                ...
                var n = ue.$injector.annotate(t), i = ee(t) ? P(t) : t;
                ...
                n = n || {};
                var i = jt.version.minor >= 3 ? "::" : "", o = function(t) {
                    var e = G(t);
                    return /^(x|data)-/.exec(e) ? "x-" + e : e
                }, a = yt(r).map(function(r) {
                    var a = r.name, u = r.type, s = o(a);
                    if (t.attr(s) && !n[a]) return s + "='" + t.attr(s) + "'";
                    var c = n[a] || a;
                    if ("@" === u) return s + "='{{" + i + "$resolve." + c + "}}'";
                    if ("&" === u) {
                        var f = e.getResolvable(c), l = f && f.data, h = l && ue.$injector.annotate(l) || [];
                        return s + "='$resolve." + c + (ee(l) ? "[" + (l.length - 1) + "]" : "") + "(" + h.join(",") + ")'"
                    }
            ...
            return ii(te(t.bindToController) ? t.bindToController : t.scope)
        }, ii = function(t) {
            return Object.keys(t || {}).map(function(e) {
                return [e, /^([=<@&])[?]?(.*)/.exec(t[e])]
            }).filter(function(t) {
            ...
            function t(e, r) {
                this.stateRegistry = e, this.stateService = r, h(Lt(t.prototype), this, Lt(this))
            }

            return t.prototype.decorator = function(t, e) {
                return this.stateRegistry.decorator(t, e) || this
            }, t.prototype.state = function(t, e) {
                return te(t) ? e = t : e.name = t, this.stateRegistry.register(e), this
            ...
            return function(e, r) {
                ...
                return n ? function(t, e) {
                    var r = new sr(t.treeChanges(i)), o = he(yi(r), {$state$: e, $transition$: t});
                    return ue.$injector.invoke(n, this, o)
                } : void 0
            }
        }, ui = function() {
            function t(t) {
            ...
            return t.prototype.dispose = function() {
                ...
                return (t = te(t) ? t.enabled : t) && this.$sniffer.history
            ...
            return t.prototype.$get = function() {
                ...
                var r = new qr(function() {
                    return t(ue.$injector, e._router.locationService)
                }, f);
                return this._urlRouter.rule(r), this
            }, t.prototype.otherwise = function(t) {
                var e = this, r = this._urlRouter;
                if (Xt(t)) r.otherwise(t); else {
                ...
                return (ee(r) || Yt(r)) && (r = t.injectableHandler(this._router, r)), this._urlRouter.when(e, r), this
            }, t.injectableHandler = function(t, e) {
                return function(r) {
                    return ue.$injector.invoke(e, null, {$match: r, $stateParams: t.globals.params})
                }
            }, t.prototype.deferIntercept = function(t) {
                this._urlRouter.deferIntercept(t)
            }, t
        }();
    jt.module("ui.router.angular1", []);
    var ci = jt.module("ui.router.init", []), fi = jt.module("ui.router.util", ["ng", "ui.router.init"]),
        li = jt.module("ui.router.router", ["ui.router.util"]),
        hi = jt.module("ui.router.state", ["ui.router.router", "ui.router.util", "ui.router.angular1"]),
        pi = jt.module("ui.router", ["ui.router.init", "ui.router.state", "ui.router.angular1"]),
        di = (jt.module("ui.router.compat", ["ui.router"]), null);
    ...
    _t.$inject = ["$rootScope"], ci.provider("$uiRouter", gt), li.provider("$urlRouter", ["$uiRouterProvider", function(t) {
    ...
    var mi, yi = function(t) {
        return t.getTokens().filter(Xt).map(function(e) {
    ...
    mi = ["$uiRouter", "$timeout", function(t, e) {
        ...
        return {
            restrict: "A", require: ["?^uiSrefActive", "?^uiSrefActiveEq"], link: function(n, i, o, a) {
                ...
                var s, c = Rt(i), f = a[1] || a[0], l = null, h = {}, p = function() {
                    return bt(r, i, h)
                }, d = $t(o.uiSref);
                ...
                }, !0), h.uiStateParams = he({}, n.$eval(d.paramExpr))), u(), n.$on("$destroy", t.stateRegistry.onStatesChanged(u)), n.$on("$destroy", t.transitionService.onSuccess({}, u)), c.clickable && (s = Et(i, r, e, c, p), Tt(i, n, s, h.uiStateOpts))
            }
        }
    }];
    var gi;
    gi = ["$uiRouter", "$timeout", function(t, e) {
        ...
        return {
            restrict: "A", require: ["?^uiSrefActive", "?^uiSrefActiveEq"], link: function(n, i, o, a) {
                ...
                var s, c = Rt(i), f = a[1] || a[0], h = null, p = {}, d = function() {
                    return bt(r, i, p)
                ...
                }), u(), n.$on("$destroy", t.stateRegistry.onStatesChanged(u)), n.$on("$destroy", t.transitionService.onSuccess({}, u)), c.clickable && (s = Et(i, r, e, c, d), Tt(i, n, s, p.uiStateOpts))
            }
        }
    }];
    var wi;
    wi = ["$state", "$stateParams", "$interpolate", "$uiRouter", function(t, e, r, n) {
        return {
            restrict: "A", controller: ["$scope", "$element", "$attrs", function(e, i, o) {
                ...
                function u(e, r, n) {
                    var o = {state: t.get(e, St(i)) || {name: e}, params: r, activeClass: n};
                ...
                function s() {
                    ...
                    }, o = n(p).concat(r(c)).reduce(Ce, []), a = n(p.filter(function(e) {
                        return t.includes(e.state.name, e.params)
                    })), u = !!p.filter(function(e) {
                        return t.is(e.state.name, e.params)
                    }).length ? r(c) : [], s = a.concat(u).reduce(Ce, []), l = o.filter(function(t) {
                        return !ve(s, t)
                    });
                ...
                h = h || r(o.uiSrefActive || "", !1)(e), te(h) && le(h, function(t, r) {
                    if (Xt(t)) {
                        var n = $t(t);
    ...
    }], jt.module("ui.router.state").directive("uiSref", mi).directive("uiSrefActive", wi).directive("uiSrefActiveEq", wi).directive("uiState", gi), Pt.$inject = ["$state"], kt.$inject = ["$state"], jt.module("ui.router.state").filter("isState", Pt).filter("includedByState", kt);
    var _i;
    _i = ["$view", "$animate", "$uiViewScroll", "$interpolate", "$q", function(t, e, r, n, i) {
        function o(t, r) {
            return {
                enter: function(t, r, n) {
                    jt.version.minor > 2 ? e.enter(t, null, r).then(n) : e.enter(t, null, r, n)
                }, leave: function(t, r) {
                    jt.version.minor > 2 ? e.leave(t).then(r) : e.leave(t, r)
                }
            }
        }
                ...
                return function(e, c, l) {
                    function h() {
                        if (d && (Me.traceUIViewEvent("Removing (previous) el", d.data("$uiView")), d.remove(), d = null), m && (Me.traceUIViewEvent("Destroying scope", R), m.$destroy(), m = null), v) {
                            ...
                            Me.traceUIViewEvent("Animate out", t), _.leave(v, function() {
                    ...
                    function p(t) {
                        ...
                        var l = f(n, function(t) {
                            t.data("$uiViewAnim", s), t.data("$uiView", u), _.enter(t, c, function() {
                                o.resolve(), m && m.$emit("$viewContentAnimationEnded"), (Jt(w) && !w || e.$eval(w)) && r(t)
                            }), h()
                        });
                        v = l, (m = n).$emit("$viewContentLoaded", t || $), m.$eval(g)
                    }

                    var d, v, m, y, g = l.onload || "", w = l.autoscroll, _ = o(), $ = void 0,
                        S = c.inheritedData("$uiView") || u, b = n(l.uiView || l.name || "")(e) || "$default", R = {
                            ...
                            configUpdated: function(t) {
                                (!t || t instanceof ei) && (a($, t) || (Me.traceUIViewConfigUpdated(R, t && t.viewDecl && t.viewDecl.$context), $ = t, p(t)))
                            },
                            get creationContext() {
                                var t = Ht("$cfg.viewDecl.$context")(S), e = Ht("$uiView.creationContext")(S);
                                return t || e
                            }
                        };
    ...
    var $i = "function" == typeof jt.module("ui.router").component, Si = 0;
    jt.module("ui.router.state").directive("uiView", _i), jt.module("ui.router.state").directive("uiView", Ot), jt.module("ui.router.state").provider("$uiViewScroll", function() {
        var t = !1;
